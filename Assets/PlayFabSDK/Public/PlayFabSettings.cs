...
namespace PlayFab
{
    ...
    public static class PlayFabSettings
    {
        ...
        public static string TitleId = "63E3"; // You must set this value for PlayFabSdk to work properly (Found in the Game Manager for your title, at the PlayFab Website)
